...
class FakeCopyReference:
    ...
    def delete(self):
        self.database.deleted_copy_ids.append(
            self.copy_id
        )
...
class FakeBookReference:
    ...
    def delete(self):
        self.database.deleted_book_ids.append(
            self.book_id
        )
...
def deletion_environment(
    ...
    monkeypatch.setattr(
        ...
        lambda book_id: sync_calls.append(
            book_id
        ),
    )
