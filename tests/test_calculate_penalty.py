...
def test_scrum_678_calculate_one_day_overdue_penalty():
    ...
    result = penalty_routes.calculate_penalty_amount(yesterday.strftime("%Y-%m-%d"))
...
def test_scrum_678_calculate_five_days_overdue_penalty():
    ...
    result = penalty_routes.calculate_penalty_amount(five_days_ago.strftime("%Y-%m-%d"))
...
def test_scrum_678_no_penalty_for_future_due_date():
    ...
    result = penalty_routes.calculate_penalty_amount(future_day.strftime("%Y-%m-%d"))
...
def test_scrum_678_no_penalty_for_today_due_date():
    ...
    result = penalty_routes.calculate_penalty_amount(today.strftime("%Y-%m-%d"))
